    ...
    try {
        ...
        if ($conexion != null) {
            ...
            foreach ($imagenes['tmp_name'] as $index => $tmpName) {
                ...
                $dataImagen = file_get_contents($tmpName);   // Contenido binario de la imagen

                // Insertar imagen en la base de datos
                $resultado = $conexion->prepare("INSERT INTO Imagenes (perfilId, nombre, tipo, datos) 
                                                 VALUES (:perfilId, :nombre, :tipo, :datos)");
